...
import { Image, Flex, Box, VStack, Text, Heading, HStack, WrapItem } from '@chakra-ui/react';
      ...
      <Box
        ...
        >
          <Flex mr={40} justifyContent="space-evenly">
            ...
            <HStack spacing={['4','20', '48']}>
              <Image boxShadow='dark-lg' mt={16} src="./restoChefB.jpg" justifyContent="center" alignSelf="center" justifySelf='center' alt="Mario simage" boxSize={['100px','140px', '250px']} borderRadius='10px'/>
              <Image boxShadow='dark-lg' position='absolute' src="./MarioAdrian.jpg" justifyContent="center" alignSelf="center" justifySelf='center' alt="Mario and Adrian image" boxSize={['100px','120px', '250px']} borderRadius='10px'/>
            </HStack>
          </Flex>
      </Box>
  )
